...
savebtn.config(font=('arial', 20, 'bold'), bg="Green", fg="white")

fontbtn=Menubutton(root, text="Font")
fontbtn.config(font=('arial', 20, 'bold'), bg="Green", fg="white")
...
boldbtn.config(font=('arrial', 20, 'bold'), bg="Green", fg="white")
